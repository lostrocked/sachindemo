 ...
 *
 */
@DevTestVirtualServer(registryHost = "10.252.213.144", deployServiceToVse = "VSE",groupName="V3UpdateTest")
public class VirtualServiceV3UpdateTest {
    ...
    public void vsV3_Deploy(){
        ResponseParser op8Response = HttpUtils.GET(HttpUtils.URL_FORMAT, "http", "10.252.213.144",
                "24778","import/test/operation-8");
        ResponseParser op9Response = HttpUtils.GET(HttpUtils.URL_FORMAT, "http", "10.252.213.144",
